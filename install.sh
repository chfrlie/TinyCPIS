Hello! Thanks for using chfrlies install script on GitHub, We will now install TinyCP for you. Please enter the password you want for the control panel when it asks.
